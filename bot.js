...
async function update() {
    ...
    var altorole = bot.users.filter(t => !t.roles.has('687910716849782856') && m.presence.game != null && m.presence.game.type == 0 && m.presence.game.name === 'ATLAS')
    ...
    altorole.forEach(function(m, i) {
      m.member.addrole('687910716849782856');
    })  
