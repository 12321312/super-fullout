...
async function update() {
    ...
    let nahalo = bot.guilds.get('584827387607515137').members.filter(d => !d.roles.has('629544609185267723') && !d.roles.some(d=>["Администрация", "zxz-tv", "Розовое чудо", "Администрация", "Модератор", "Qusoriance*", "Легенда пустошей", "Охотник на зверожогов", "Потрошитель", "Опытный", "Житель", "Неизвестный"].includes(d.name)));
    ...
    let voiceChs = bot.guilds.get('584827387607515137').channels.filter(c => c.id === '628604126149869569' || c.id === '629554985331326996' || c.id === '629554945359872020' || c.id === '629555066537508894' || c.id === '629555136762740737' || c.id === '663345045373452309' || c.id === '665641401257689099' || c.id === '655058703606611969');
