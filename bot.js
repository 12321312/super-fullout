...
async function update() {
    ...
    let altolow = bot.guilds.gen('584827387607515137').channels.get('584832686208843826').members.filter(m => m.presence.game != null && m.presence.game.type == 0 && m.presence.game.name === 'ATLAS')
